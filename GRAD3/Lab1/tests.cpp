...
namespace test_case
{
    ...
    void Test_pop_front(std::ostream &output_stream)
    {
        output_stream << "Running Test_pop_front..." << std::endl;
        LinkedListSequence<int> list;
        assert(list.get_length() == 0);
        list.append(1);
        assert(list.get_first() == 1);
        ...
        list.pop_front();
        assert(list.get_length() == 0);
        output_stream << "Test_pop_front completed successfully." << std::endl;
    }
